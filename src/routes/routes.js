...
/**
 * @endpoint /stream
 * @description Get streaming link from a server
 * @query id - AniList ID with ?ep=episode (example: 1535?ep=2142)
 * @query server - Server name (megacloud, vidwish, vidnest, HD-4)
 * 
 * Example:
 *   /stream?id=1535?ep=2142&server=vidnest
 */
...
<html lang="en">
  ...
  <body>
    ...
    <a href="https://discord.gg/pqzZegPN">here</a>
  </body>
</html>
    `);
});
